...
@onready var chk_align_y: CheckBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer/chk_align_y
@onready var chk_rand_x: CheckBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer/chk_rand_x
@onready var chk_rand_y: CheckBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer/chk_rand_y
@onready var chk_rand_z: CheckBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer/chk_rand_z
@onready var sb_scale_min: SpinBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer2/sb_scale_min
@onready var sb_scale_max: SpinBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer2/sb_scale_max

@onready var chk_grid: CheckBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer3/chk_grid
@onready var sb_grid_x: SpinBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer4/sb_grid_x
@onready var sb_grid_y: SpinBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer4/sb_grid_y
@onready var sb_grid_z: SpinBox = $vbox/HBoxContainer/PanelContainer/VBoxContainer/HBoxContainer4/sb_grid_z
...
func _on_btn_add_asset_button_down():
	...
	dialog.add_filter("*.tscn, *.scn, *.glb; Scenes")
	add_child(dialog)
	dialog.show()
	dialog.invalidate()
...
func get_placement_options():
	...
	ret["grid"] = chk_grid.button_pressed
	ret["grid_size"] = Vector3i(sb_grid_x.value, sb_grid_y.value, sb_grid_z.value)
	return ret
...
func set_data_from_save(data):
	...
	chk_grid.button_pressed = data["grid"]
	sb_grid_x.value = int(data["grid_size"].x)
	sb_grid_y.value = int(data["grid_size"].y)
	sb_grid_z.value = int(data["grid_size"].z)
